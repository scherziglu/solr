...
public class TestLatinNumberNormalizationFilterFactory extends BaseTokenStreamTestCase {
	...
	public void testApostrophus() throws Exception {
		...
		mockTokenizer.setReader(new StringReader("CCCIↃↃↃ IↃↃↃ CCIↃↃ IↃↃ CIↃ IↃ"));	// new StringReader("CCCCIↃↃↃↃ IↃↃↃↃ CCCIↃↃↃ IↃↃↃ CCIↃↃ IↃↃ CIↃ IↃ");
		TokenStream stream = this.factory.create(mockTokenizer);
		assertTokenStreamContents(stream, new String[] {"\u2188","\u2187", "\u2182", "\u2181", "M", "D"});
	}

	public void testUpperCase() throws Exception {
		MockTokenizer mockTokenizer = new MockTokenizer(MockTokenizer.WHITESPACE, false);
		mockTokenizer.setReader(new StringReader("Ⅰ \u2160 Ⅱ \u2161 Ⅲ \u2162 Ⅳ \u2163 Ⅴ \u2164 Ⅵ \u2165 Ⅶ \u2166 Ⅷ \u2167 Ⅸ \u2168 Ⅹ \u2169 Ⅺ \u216A Ⅻ \u216B Ⅼ \u216C Ⅽ \u216D Ⅾ \u216E Ⅿ \u216F"));	
		TokenStream stream = this.factory.create(mockTokenizer);
	...
	public void testSpecials() throws Exception {
		MockTokenizer mockTokenizer = new MockTokenizer(MockTokenizer.WHITESPACE, false);
		mockTokenizer.setReader(new StringReader("Ↄ \u2183 ↄ \u2184 \u2185 \u2186"));
		TokenStream stream = this.factory.create(mockTokenizer);
	...
	public void testCombinations() throws Exception {
		MockTokenizer mockTokenizer = new MockTokenizer(MockTokenizer.WHITESPACE, false);
		mockTokenizer.setReader(new StringReader("CCCIↃↃↃⅫ"));
		TokenStream stream = this.factory.create(mockTokenizer);
